...
export default function Home() {
  ...
  return (
    // <main className={`flex min-h-screen flex-col items-center justify-between p-24  mt-[50px] ${theme=="dark"?"bg-page_bg_dark":"bg-page_bg_light"}`}>
    ...
    //       rel="noopener noreferrer"
    //     >
    //       <h2 className={`mb-3 text-sm font-semibold bg-blue text-red`}>
    //         Docs{' '}
    ...
    //     </a>
    //     <p
    //       className={`m-0 max-w-[30ch] text-2xl opacity-50 text-red-600 bg-amber-500`}
    //     >
    ...
    >
      ...
      <div className="relative xs:ml-[5px] md:ml-[15px] lg:ml-[380px] my-2 flex-grow  bg-transparent">
